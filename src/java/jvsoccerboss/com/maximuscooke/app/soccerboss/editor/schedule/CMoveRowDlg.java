...
public class CMoveRowDlg extends CDlgBase
{
	...
	public CMoveRowDlg()
	{
		super("Move Row", "Move Row Fixtures", "Move all scheduled fixtures in row to a new date", 450, 250, CResource.getResourceAsImageIcon(CSoccerBoss.RES_DIR + "nd0047-48.png"), true);
	...
	protected void onOkClicked()
	{
		...
		this.mSchedule.move(selItem.getDate(), this.mDate.getDateValue());
...
class CMoveRowItem
{
	private CGregorianCalendar mDate;
	
	public CMoveRowItem(CGregorianCalendar d)
	{
		this.mDate = d;
	}
	...
	{
		return CGregorianCalendar.toString(this.mDate, "EEE, d MMM yyyy");
	}

	public final CGregorianCalendar getDate()
	{
		return mDate;
	}
}
